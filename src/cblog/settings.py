...
DATABASES = {
    'default': {
        ...
        'HOST': 'aws-capstone-rds.ciwo9y2yudpa.us-east-1.rds.amazonaws.com',  # database endpoint is written here
...
AWS_STORAGE_BUCKET_NAME = 'awscapstones3adamsblog' # please enter your s3 bucket name
